                           ...
                           <div class="card shadow-sm">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table id="trainerTable" class="table table-bordered table-striped table-hover mb-0">
                                        <thead class="bg-light">
                                            <tr>
                                                ...
                                                <th class="py-3 px-2" style="width: 150px; min-width: 150px;">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($memberships as $item)
                                            <tr>
                                                <td class="py-2 px-2 align-middle">
                                                    <img src="{{ asset('storage/' . $item->memberphoto) }}" class="rounded-circle shadow-sm"
                                                       width="40" height="40" alt="{{ $item->member_name }}"
                                                       onerror="this.src='/default-avatar.png'">
                                                </td>
                                                <td class="py-2 px-2 align-middle">{{ $item->member_name }}</td>
                                                <td class="py-2 px-2 align-middle">{{ $item->phone }}</td>
                                                <td class="py-2 px-2 align-middle">
                                                    <a href="mailto:{{ $item->email }}" class="text-decoration-none">{{ Str::limit($item->email,
                                                        20) }}</a>
                                                </td>
                                                <td class="py-2 px-2 align-middle">{{ Str::limit($item->address, 25) }}</td>
                                                ...
                                                <td class="py-2 px-2 align-middle">Rs {{ number_format($item->price, 2) }}</td>
                                                <td class="py-2 px-2 align-middle">
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-primary btn-sm" title="Edit" data-toggle="modal"
                                                           data-target="#updateModel{{ $item->id }}">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-info btn-sm" title="View" data-toggle="modal"
                                                           data-target="#viewModel{{ $item->id }}">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-4 text-center mb-3 mb-md-0">
                                                                            <img src="{{ asset('storage/' . $item->memberphoto) }}"
                                                                                alt="{{ $item->member_name }}"class="img-fluid rounded shadow"
                                                                               style="max-height: 200px; width: auto;">
                                                                        </div>
                                                                        <div class="col-md-8">
                                                                            <dl class="row mb-0">
                                                                                <dt class="col-sm-4">Name:</dt>
                                                                                <dd class="col-sm-8">{{ $item->member_name }}</dd>
                                                                                ...
                                                                                <dd class="col-sm-8">{{ $item->membership_type }}</dd>
                                                                                <dt class="col-sm-4">Start Date:</dt>
                                                                                <dd class="col-sm-8">{{ $item->start_date }}</dd>
                                                                                <dt class="col-sm-4">End Date:</dt>
                                                                                <dd class="col-sm-8">{{ $item->end_date }}</dd>
                                                                                <dt class="col-sm-4">Price:</dt>
                                                                                <dd class="col-sm-8">Rs {{ number_format($item->price, 2) }}
                                                                                </dd>
                                                                            </dl>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="modal fade" id="updateModel{{ $item->id }}" tabindex="-1" role="dialog">
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h4 class="modal-title"><i class="fas fa-edit mr-2"></i>Update Member</h4>
                                                            <button type="button" class="close text-white" data-dismiss="modal"
                                                               aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ url('UpdateMembership/' . $item->id) }}" method="POST"
                                                               enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="member_name{{ $item->id }}"
                                                                                class="font-weight-bold">Member Name:</label>
                                                                            <input type="text" id="member_name{{ $item->id }}"
                                                                               name="member_name" value="{{ $item->member_name }}"
                                                                                class="form-control" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="phone{{ $item->id }}"
                                                                                class="font-weight-bold">Phone:</label>
                                                                            <input type="tel" id="phone{{ $item->id }}" name="phone"
                                                                               value="{{ $item->phone }}" class="form-control" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="address{{ $item->id }}"
                                                                                class="font-weight-bold">Address:</label>
                                                                            <textarea id="address{{ $item->id }}" name="address"
                                                                               class="form-control" rows="2">{{ $item->address }}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="membership_type{{ $item->id }}"
                                                                                class="font-weight-bold">Membership Type:</label>
                                                                            <select id="membership_type{{ $item->id }}" name="membership_type"
                                                                               class="form-control" required>
                                                                                <option value="Basic" {{ $item->membership_type == 'Basic' ?
                                                                                    'selected' : '' }}>Basic</option>
                                                                                <option value="Standard" {{ $item->membership_type == 'Standard'
                                                                                    ? 'selected' : '' }}>Standard</option>
                                                                                <option value="Premium" {{ $item->membership_type == 'Premium' ?
                                                                                    'selected' : '' }}>Premium</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="start_date{{ $item->id }}"
                                                                                class="font-weight-bold">Start Date:</label>
                                                                            <input type="date" id="start_date{{ $item->id }}" name="start_date"
                                                                               value="{{ $item->start_date }}" class="form-control" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="end_date{{ $item->id }}" class="font-weight-bold">End
                                                                                Date:</label>
                                                                            <input type="date" id="end_date{{ $item->id }}" name="end_date"
                                                                               value="{{ $item->end_date }}" class="form-control" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="price{{ $item->id }}"
                                                                                class="font-weight-bold">Price:</label>
                                                                            <input type="number" id="price{{ $item->id }}" name="price"
                                                                                value="{{ $item->price }}" class="form-control"step="0.01"
                                                                                min="0" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="memberphoto{{ $item->id }}"
                                                                                class="font-weight-bold">Photo:</label>
                                                                            <input type="file" id="memberphoto{{ $item->id }}"
                                                                               name="memberphoto" class="form-control-file">
                                                                            @if($item->memberphoto)
                                                                            <div class="mt-2">
                                                                                <img src="{{ asset('storage/'.$item->memberphoto) }}"
